...
object Constantsjuego7 {
    ...
    fun getQuestions(): ArrayList<Preguntasjuego7>{
        ...
        val que1= Preguntasjuego7(1,
            "Aurten zenbagarren txotx irekiera izango dugu aurten",
            "28. txotx irekiera",
            "25. txotx irekiera",
            "23. txotx irekiera",
            1)
        ...
        val que2= Preguntasjuego7(2,
            "Zein hilabetetan izaten da txotx irekiera?",
            "Urtarrilan",
            "Otsailan",
            "Martxoan",
            1)
        ...
        val que3= Preguntasjuego7(3,
            "Zein izan zen azkenengo txotx irekierako gonbidatua? Zein sagardotegitan ospatu zen?",
            "Onintza Enbeitia",
            "Aitziber Garmendia",
            "Izaro Andres",
            3)
        ...
        val que4= Preguntasjuego7(4,
            "Zein jarduera egiten dira txotx irekieraren egunean?",
        ...
        val que5= Preguntasjuego7(5,
            "Zein sagardotegitan ospatu zen azkeneko txotx irekiera? ",
            "Alorrenea Sagardotegian",
            "Petritegi Sagardotegian",
            "Lizeaga Sagardotegian",
            1)
        val que6_1= Preguntasjuego7(6_1,
            "Zein da hitz hauen esanahia?: txotx, kizki, kupela, ama, zizarra, dolare." +
                    "TXOTX:",
