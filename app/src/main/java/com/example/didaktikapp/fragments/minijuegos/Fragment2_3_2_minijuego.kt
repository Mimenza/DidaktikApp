...
class Fragment2_3_2_minijuego : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view= inflater.inflate(R.layout.fragment2_3_2_minijuego, container, false)
        ...
        button.setOnClickListener(){
            Navigation.findNavController(view).navigate(R.id.action_fragment2_3_2_minijuego_to_fragment4_menu)
        }
